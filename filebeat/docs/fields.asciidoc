...
*`scouter.log.javaee.active_service`*::
+
--
type: integer
...
*`scouter.log.javaee.api_error_rate`*::
+
--
type: float
...
*`scouter.log.javaee.api_time_by_service`*::
+
--
type: integer
...
*`scouter.log.javaee.elapsed_almost`*::
+
--
type: integer
...
*`scouter.log.javaee.elapsed_time`*::
+
--
type: integer
...
*`scouter.log.javaee.perm_percent`*::
+
--
type: float
...
*`scouter.log.javaee.recent_user`*::
+
--
type: integer
...
*`scouter.log.javaee.service_count`*::
+
--
type: integer
...
*`scouter.log.javaee.sql_error_rate`*::
+
--
type: float
...
*`scouter.log.javaee.sql_time_by_service`*::
+
--
type: integer
...
*`scouter.log.host.disk_read_bytes`*::
+
--
type: long
...
*`scouter.log.host.disk_write_bytes`*::
+
--
type: long
...
*`scouter.log.host.swap_page_out`*::
+
--
type: integer
...
*`scouter.log.tracing.alloc_memory`*::
+
--
type: long
...
*`scouter.log.tracing.api_call_count`*::
+
--
type: integer
...
*`scouter.log.tracing.api_call_time`*::
+
--
type: long
...
*`scouter.log.tracing.end_time_epoch`*::
+
--
type: long
...
*`scouter.log.tracing.error_cause`*::
+
--
type: keyword
...
*`scouter.log.tracing.start_time_epoch`*::
+
--
type: long
...
*`scouter.log.tracing.service_name`*::
+
--
type: keyword
...
*`scouter.log.tracing.thread_name`*::
+
--
type: keyword
...
*`scouter.log.reqproc.bytes_received`*::
+
--
type: long
...
*`scouter.log.reqproc.bytes_sent`*::
+
--
type: long
...
*`scouter.log.reqproc.error_count`*::
+
--
type: integer
...
*`scouter.log.reqproc.processing_time`*::
+
--
type: long
...
*`scouter.log.reqproc.request_count`*::
+
--
type: integer
